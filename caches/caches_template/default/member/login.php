...
<div id="content">
<div class="col-left form-login" id="logindiv" style=" margin-left:180px;">
...
<input type="hidden" name="forward" id="forward" value="<?php echo $forward;?>">
		...
		<div class="submit"><input type="submit" name="dosubmit" id="dosubmit" value="<?php echo L('login');?>"></div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php?m=member&c=index&a=public_forget_password&siteid=<?php echo $siteid;?>" class="blue"><?php echo L('forgetpassword');?></a>
