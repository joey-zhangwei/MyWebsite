...
?>
    <tr>
		...
		<td align="left"><?php if($v['islock']) {?><img title="<?php echo L('lock')?>" src="<?php echo IMG_PATH?>icon/icon_padlock.gif"><?php }?><?php if($v['islook']) {?><img title="不可见" src="<?php echo IMG_PATH?>icon/yinshen.jpg"><?php }?></td>
...
<input type="submit" class="button" name="dosubmit" onclick="document.myform.action='?m=member&c=member&a=look'" value="可见"/>
<input type="submit" class="button" name="dosubmit" onclick="document.myform.action='?m=member&c=member&a=unlook'" value="不可见"/>
</div>
